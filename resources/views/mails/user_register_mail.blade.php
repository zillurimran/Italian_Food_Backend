                        ...
                        <td align="center" style="font-family: 'sans-serif',sans-serif;">
                            ...
                            <tr>
                                <td style="background-color: #ffffff; border-radius: 4px; font-family: sans-serif, -apple-system, 'Segoe UI', sans-serif; font-size: 14px; line-height: 24px; padding: 48px; text-align: left; color: #666;" bgcolor="#ffffff">
                                    ...
                                    <p style="font-size: 18px; margin: 0 0 24px;">You have successfully registered on <strong>{{ config('app.name') }}</strong>.</p>
                                    <p style="font-size: 16px; margin: 0 0 24px;"><strong>Your Username is:</strong> <span>{{ $email }}</span></p>
                                    <p style="font-size: 16px; margin: 0 0 24px;"><strong>Your Password is:</strong> <span>{{ $email }}</span></p>

                                    <p>Please change your password asap!</p>
