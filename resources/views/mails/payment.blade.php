                        ...
                        <td align="center" style="font-family: 'sans-serif',sans-serif;">
                            ...
                            <tr>
                                <td style="background-color: #ffffff; border-radius: 4px; font-family: sans-serif, -apple-system, 'Segoe UI', sans-serif; font-size: 14px; line-height: 24px; padding: 48px; text-align: left; color: #666;" bgcolor="#ffffff">
                                    <p style=" font-size: 18px; margin-bottom: 0;">Payment Successful</p>
                                    <p style="color: #09122a; font-weight: 700; font-size: 20px; margin-top: 5px;">
                                        <strong>{{ $name }}</strong>
                                    </p>
                                    <p style="font-size: 16px; margin: 0 0 24px;">You have purchased {{ $package_type }} package from {{ config('app.name') }}.</p>
                                    <table style="font-family: sans-serif; margin-top: 24px; border-left: 3px solid #ff8500; background: #f7f7f7; color: #151515;" cellpadding="0" cellspacing="0" role="presentation">
                                        <tr>
                                            <td style="padding: 15px">
                                                <p style="font-family: sans-serif; margin-top: 0;">Customer & Product Information</p>
                                                <table>
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            <td align="left">
                                                                <strong>Customer Name: </strong><span>{{ $name }}</span>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td align="left">
                                                        ...
                                                        <tr>
                                                            <td align="left">
                                                                <strong>Package Type: </strong><span>{{ $package_type }}</span>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td align="left">
                                                                <strong>Package Price: </strong><span>{{ $package_price }}</span>
                                                        </tr>
                                                        <tr>
                                                            <td align="left">
                                                                <strong>SMS Quantity: </strong><span>{{ $sms_quantity }}</span>
                                                            </td>
                                                        </tr>
                                                    </tbody>
                                                </table>
