                ...
                <table style="font-family: 'sans-serif',sans-serif; width: 600px;" width="600" cellpadding="0" cellspacing="0" role="presentation">
                    <tr>
                        <td style="font-family: sans-serif, -apple-system, 'Segoe UI', sans-serif; padding: 48px; text-align: center;" align="center">
                            <a href="https://sms-bulk.contact-support.co/">
                                <img src="{{ asset('uploads/generalSettings') }}/{{ generalsettings()->logo }}" height="45" alt="Sticko Logo" style="border: 0; max-width: 100%; line-height: 100%; vertical-align: middle;">
                            </a>
                        </td>
                    </tr>
                    <tr>
                            ...
                            <tr>
                                <td style="background-color: #ffffff; border-radius: 4px; font-family: sans-serif, -apple-system, 'Segoe UI', sans-serif; font-size: 14px; line-height: 24px; padding: 48px; text-align: left; color: #666;" bgcolor="#ffffff">
                                    ...
                                    <p style="color: #09122a; font-weight: 700; font-size: 20px; margin-top: 5px;">
                                        <strong>Welcome to our SMS service</strong>
                                    </p>
                                    <h5 style="color: #AF1F00">Congratulations!!!</h5>
                                    <p style="font-size: 18px; margin: 0 0 24px;">You have successfully registered on <strong>{{ config('app.name') }}</strong>. In order to continue to use our service, please verify your email by clicking on the button below.</p>

                                    <table style="font-family: 'sans-serif',sans-serif; margin-top: 24px;" cellpadding="0" cellspacing="0" role="presentation">
                                        <tr>
                                            <td align="right" style="background-color: #000000; border-radius: 4px; font-family: sans-serif, -apple-system, 'Segoe UI', sans-serif;" bgcolor="#ff8500">
                                                <a href="{{ $url }}" style="display: block; font-weight: 600; font-size: 14px; line-height: 100%; padding: 16px 24px; color: #ffffff; text-decoration: none;">Verify Email ↗</a>
                                            </td>
                                        </tr>
                                    </table>
