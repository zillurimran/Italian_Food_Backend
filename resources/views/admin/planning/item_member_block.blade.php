@forelse ($order->getItemMemebers->take(5) as $member)
@php
...
@empty 
@endforelse 
@if ($order->getItemMemebers->count() > 5)
<li class="card-block__user-list__item-end">
    <span class="card-block__user-list__item-end__text">{{ $order->getItemMemebers->count() -5 }}</span>
