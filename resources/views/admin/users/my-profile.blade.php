                    ...
                    <div class="card-body py-2">
                        <form action="#!">
                            <div class="d-flex flex-wrap align-items-end">
                                <div class="mr-1 mb-1">
                                  <img src="https://i.pravatar.cc/300" data-reset-src="https://i.pravatar.cc/300" id="account-upload-img" class="uploadedAvatar rounded object-fit--cover" alt="profile image" width="100" height="100">
                                </div>
