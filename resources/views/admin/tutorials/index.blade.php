...
{{-- Title --}}
@section('title')
    {{ config('app.name') }} | Tutorial Steps
@endsection
...
<div class="card">
    <div class="card-header">
        <h3 class="card-title">All Tutorial Steps</h3>    
        <div>
                ...
                <table class="table table-bordered datatable">
                    <thead>
                        <tr>
                            ...
                            <th class="nowrap">Tutorial Title</th>
                            <th class="nowrap">Tutorial Sub_title</th>
                    ...
                    <tbody>
                        @foreach ($tutorialSteps as $tutorialStep)
                            <tr>
                                ...
                                <td>{{ $tutorialStep->tutorial_title }}</td> 
                                <td>{{ $tutorialStep->tutorial_sub_title }}</td>
                                <td>
                                    <img src="{{ asset('uploads/tutorials') }}/{{  $tutorialStep->image  }}" alt="" height="100px" width="100px" style="border-radius: 50%">
                                </td>
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right">
                                            <button type="button" class="dropdown-item"   data-toggle="modal" data-target="#editTutorialModal-{{ $tutorialStep->id }}">
                                                <i data-feather="edit" class="mr-50"></i>
                                                <span>Edit</span>
                                            </button>
                                            <a href="{{ route('tutorialSteps.delete', $tutorialStep->id) }}" class="dropdown-item">
